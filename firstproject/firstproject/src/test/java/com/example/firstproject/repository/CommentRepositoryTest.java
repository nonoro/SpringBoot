...
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        /* Case 1: 4번 게시글의 모든 댓글 조회 */
        {
            ...
            // 검증
            assertThat(expected.toString()).isEqualTo(comments.toString()).as("4번 글의 모든 댓글을 출력");
        }
        ...
        /* Case 2: 1번 게시글의 모든 댓글 조회*/
        {
            ...
            // 검증
            assertThat(expected.toString()).isEqualTo(comments.toString()).as("1번 글은 댓글이 없음");
        }
        ...
        /* Case 3: 9번 게시글의 모든 댓글 조회 */
        {
            ...
            List<Comment> comments = commentRepository.findByArticleId(articleId);
            // 예상하기
            Article article = new Article(9L, "마마마", "11234");
            List<Comment> expected = Arrays.asList();
            // 검증
        ...
        /* Case 4: 9999번 게시글의 모든 댓글 조회 */
        {
            ...
            List<Comment> comments = commentRepository.findByArticleId(articleId);
            // 예상하기
            Article article = new Article(9999L, "마마마", "11234");
            List<Comment> expected = Arrays.asList();
            // 검증
            assertThat(expected.toString()).isEqualTo(comments.toString());
        }
        /* Case 5: -1번 게시글의 모든 댓글 조회 */
        {
            ...
            List<Comment> comments = commentRepository.findByArticleId(articleId);
            // 예상하기
            Article article = new Article(-1L, "마마마", "11234");
            List<Comment> expected = Arrays.asList();
            // 검증
            assertThat(expected.toString()).isEqualTo(comments.toString());
        }
    ...
    void findByNickname() {
        /* Case 1: "Park"의 모든 댓글 조회 */
        {
            ...
            List<Comment> expected = Arrays.asList(a, b, c);
            // 검증
            assertThat(expected.toString()).as("Kim의 모든 댓글을 출력!").isEqualTo(comments.toString());
        }
        ...
        /* Case 2: "Kim" 의 모든 댓글 조회 */
        {
            ...
            List<Comment> expected = Arrays.asList(a, b, c);
            // 검증
            assertThat(expected.toString()).isEqualTo(comments.toString()).as("Kim의 모든 댓글을 출력!");
        }
        ...
        /* Case 3: null 의 모든 댓글 조회 */
        {
            ...
            List<Comment> expected = Arrays.asList();
            // 검증
            assertThat(expected.toString()).isEqualTo(comments.toString()).as("null의 모든 댓글을 출력!");
        }
